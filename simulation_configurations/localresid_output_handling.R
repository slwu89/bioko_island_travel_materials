"qsub -l m_mem_free=8G -l fthread=1 -P proj_mmc -q all.q -N lr_output_handling -o /ihme/malaria_modeling/dtcitron/SpatialUncertainty/ASTMH19/localresid/log_files -e /ihme/malaria_modeling/dtcitron/SpatialUncertainty/ASTMH19/localresid/log_files /ihme/singularity-images/rstudio/shells/execRscript.sh -s /ihme/malaria_modeling/dtcitron/SpatialUncertainty/ASTMH19/localresid_output_handling.R"
...
fwrite(mat_mean, here("SpatialUncertainty/ASTMH19/localresid/localresid_pr_means_1000.csv"))
fwrite(mat_sd, here("SpatialUncertainty/ASTMH19/localresid/localresid_pr_sds_1000.csv"))

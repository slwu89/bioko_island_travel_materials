...
h_inf <- here("SpatialUncertainty/ASTMH19/baseline/sim_output", paste0("pfsi_", seed, ".csv"))
...
mosy <-  here("SpatialUncertainty/ASTMH19/baseline/sim_output", paste0("mosy_", seed, ".csv"))
...
# h_inf <- here("SpatialUncertainty/ASTMH19/baseline/sim_output", paste0("pfsi_", 1, ".csv"))
# dt <- fread(h_inf)
# 

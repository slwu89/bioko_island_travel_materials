...
pfpr <- pfpr.input # "True" initial conditions, with higher PR
...
h_inf <- here("SpatialUncertainty/ASTMH19/localresid_trueICs/sim_output", paste0("pfsi_", seed, ".csv"))
...
mosy <-  here("SpatialUncertainty/ASTMH19/localresid_trueICs/sim_output", paste0("mosy_", seed, ".csv"))
...
# h_inf <- here("SpatialUncertainty/ASTMH19/localresid_trueICs/sim_output", paste0("pfsi_", 2, ".csv"))
# dt <- fread(h_inf)
# 
...
# 
# h <- melt(dt[areaId %in%  c(335, 2694)],#c(152, 207, 220,335,502, 644, 1175,2199,2457)],

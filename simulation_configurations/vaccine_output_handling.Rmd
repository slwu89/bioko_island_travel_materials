---
title: "vaccine_output_handling"
author: "Daniel T Citron"
date: "10/31/2019"
output: html_document
---

We are going to analyze the outputs from the `vaccine` simulations.
...
fwrite(mat_mean, here("SpatialUncertainty/ASTMH19/vaccine/vaccine_pr_means.csv"))
fwrite(mat_sd, here("SpatialUncertainty/ASTMH19/vaccine/vaccine_pr_sds.csv"))
```
...
# load in the first one
df <- fread(here("SpatialUncertainty/ASTMH19/vaccine/sim_output",ensemble.file.list[1]))
...
df[, run := 1]
for (k in 2:10){
  df_curr <- fread(here("SpatialUncertainty/ASTMH19/vaccine/sim_output",ensemble.file.list[k]))
...
fwrite(df, here("SpatialUncertainty/ASTMH19/vaccine/pr_subsample.csv"))
```

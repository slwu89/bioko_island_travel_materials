...
setup_mosquito_RM(model = mod, stochastic = TRUE, f = f, q = q, eip = 11, p = p, psi = psi, nu = 25, M = M, Y = Y, Z = Z)
...
setup_mosquito_RM(model = mod, stochastic = FALSE, f = f, q = q, eip = 11, p = p, psi = psi, nu = 25, M = M, Y = Y, Z = Z)
